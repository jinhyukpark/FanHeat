...
<body><main>
  ...
  <footer class="statusbar"><b>● COLLECTOR</b><div id="status" class="status">아직 실행한 작업이 없습니다.</div><div id="n8n-status" class="n8n-status" aria-live="polite"><span id="n8n-overall" class="n8n-overall">● n8n 확인 중</span><div id="n8n-workflows" class="n8n-workflows"></div><button id="refresh-n8n-status" class="n8n-refresh" type="button">새로고침</button></div></footer>
</main><script>
