    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            for (var elemItem in this.settings.elements) {
                if (this.settings.elements[elemItem] == "volume") {
                    ...
                    $.inArray("backward", this.settings.controlElements) != '-1' ? backwardElem = "<div class='rew'><i class='material-icons'>skip_previous</i></div>" : backwardElem = " ";
                    $.inArray("forward", this.settings.controlElements) != '-1' ? forwardElem = "<div class='fwd'><i class='material-icons'>skip_next</i></div>" : forwardElem = " ";
                    $.inArray("stop", this.settings.controlElements) != '-1' ? stopElem = "<div class='stop'><i class='material-icons'>get_app</i></div>" : stopElem = " ";
                    $.inArray("play", this.settings.controlElements) != '-1' ? playElem = "<div class='play'><i class='material-icons'>play_arrow</i></div><div class='pause'><i class='material-icons'>pause</i></div>" : playElem = " ";
        ...
        initAudio: function (elem) {
            ...
            this.song.addEventListener('loadeddata', function () {
                ...
                $(playerInstance.volumeAdjuster).find('div').widtht(this.volume * 100 + '%');
